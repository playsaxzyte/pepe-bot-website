...
const REVEAL_CONTENT = [
  {
    upper: ["xxxxxxx a fast Instagram bot built for real-time command handling and smooth automation.",
  "It listens, responds instantly, and keeps conversations flowing without delays.",
  "Designed for speed, simplicity, and a clean interactive messaging experience."],
  lower: "PEPE The Instagram Bot",
  },
  {
    upper: [
 "xxxxxxx Alisa Mikhailovna Kujou is a calm and intelligent Telegram bot with AI-driven replies.",
  "It supports commands and natural conversations with a smooth user experience.",
  "Focused on clarity, elegance, and meaningful interaction in every message."
    ],
    lower: "ALYA The Telegram Bot",
  },
  {
    upper: [
 "xxxxxxxss Mai~San is an interactive Discord bot with AI-powered conversations and smart triggers.",
  "It features leveling, sessions, and moderation tools to enhance server activity.",
  "Built to make communities more engaging, responsive, and alive."
    ],
    lower: "Mai~san the discord bot",
  },
];
...
const ITEMS = [
  {
    id: "twitch", label: "PEPE", handle: "@yourname", href: "https://twitch.tv/yourname", icon: "🎮", barIcon: icon1, bars: 1, newBars: [0], counts: ["56"],
  ...
  {
    id: "instagram", label: "Alisa Mikhailovna Kujou", handle: "@yourhandle", href: "https://instagram.com/yourhandle", icon: "📷", barIcon: icon2, bars: 5, newBars: [1, 2], counts: ["3.4M", "2.5M", "676K", "412K", "198K"],
  ...
  {
    id: "tiktok", label: "MAI~SAN", handle: "@yourhandle", href: "https://tiktok.com/@yourhandle", icon: "🎵", barIcon: icon3, bars: 7, newBars: [0, 3, 5, 6], counts: ["5.1M", "3.7M", "2.2M", "1.4M", "831K", "490K", "217K"],
