...
const ITEMS = [
  {
    id: "instagram", label: "INSTAGRAM", handle: "@pepebot_1", href: "https://www.instagram.com/pepebot_1/", icon: "📷", barIcon: icon1, bars: 1, newBars: [0], counts: ["56"],
    links: ["https://www.instagram.com/pepebot_1/"],
    stats: [
      { tag: "USERS", value: "420+", color: "#9147ff" },
      { tag: "VWR", value: "042",  color: "#bf94ff" },
    ],
  },
  {
    id: "", label: "TELEGRAM", handle: "https://web.telegram.org/k/#@Alyasanbot", href: "https://web.telegram.org/k/#@Alyasanbot", icon: "🎮", barIcon: icon2, bars: 1, newBars: [0], counts: ["397+"],
    links: ["https://web.telegram.org/k/#@Alyasanbot"],
    stats: [
      { tag: "USERS", value: "1.1K", color: "#e1306c" },
      { tag: "PST", value: "128",  color: "#f77737" },
    ],
  },
  {
    id: "DISCORD", label: "DISCORD", handle: "https://discord.com/oauth2/authorize?client_id=1489553991351144478&permissions=8&integration_type=0&scope=bot", href: "https://discord.com/oauth2/authorize?client_id=1489553991351144478&permissions=8&integration_type=0&scope=bot", icon: "🎵", barIcon: icon3, bars: 1, newBars: [0], counts: ["2000+"],
    links: ["https://discord.com/oauth2/authorize?client_id=1489553991351144478&permissions=8&integration_type=0&scope=bot"],
    stats: [
      { tag: "USERS", value: "920", color: "#00f2ea" },
