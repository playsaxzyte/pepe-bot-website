...
const ITEMS = [
  { id: "about",   label: "ABOUT MY BOTS",      page: "about",   fontSize: 80, offsetX: 0,  offsetY: 0,  skew: -6,  skewY: 10  },

  { id: "socials", label: "SOCIALS",       page: "socials", fontSize: 74, offsetX: 16, offsetY: 8,  skew: -3,  skewY: 5   },
  { id: "CONTACT",label: "CONTACT ME", page: "projects",fontSize: 56, offsetX: 10, offsetY: 6,  skew: -4,  skewY: 7   },
];
...
export default function P3Menu({ onNavigate }) {
  ...
  if (current.page === "projects" || current.id === "sideproj") {
    window.open("https://www.instagram.com/axzyteplays/", "_blank");
  } else {
...
onClick={(e) => {
  ...
  if (item.page === "projects" || item.id === "sideproj") {
    window.open("https://www.instagram.com/axzyteplays/", "_blank");
  } else {
